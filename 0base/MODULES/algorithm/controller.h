...
typedef enum
{
    ...
    PID_Integral_Limit = 1,              // 0000 0001
    PID_Derivative_On_Measurement = 2,   // 0000 0010
    PID_Trapezoid_Intergral = 4,        // 0000 0100
    PID_Proportional_On_Measurement = 8, // 0000 1000
    PID_OutputFilter = 16,                // 0001 0000
    PID_ChangingIntegrationRate = 32,     // 0010 0000
    PID_DerivativeFilter = 64,            // 0100 0000
    PID_ErrorHandle = 128                // 1000 0000
} PID_Improvement_e;
