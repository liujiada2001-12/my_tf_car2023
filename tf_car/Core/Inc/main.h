...
#define FR_light_Pin GPIO_PIN_7
#define FR_light_GPIO_Port GPIOG
#define FL_light_Pin GPIO_PIN_8
#define FL_light_GPIO_Port GPIOG
#define motor1_c1_Pin GPIO_PIN_15
#define motor1_c1_GPIO_Port GPIOA
#define ML_light_Pin GPIO_PIN_9
#define ML_light_GPIO_Port GPIOG
#define MR_light_Pin GPIO_PIN_10
#define MR_light_GPIO_Port GPIOG
#define Light_Pin GPIO_PIN_11
#define Light_GPIO_Port GPIOG
