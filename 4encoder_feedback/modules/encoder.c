...
void motor_encoder_getdata()
{
	...
	motor1speed=(float) encoder1count*100/150/11/4;
	motor2speed=(float) encoder2count*100/150/11/4;
	motor3speed=(float) encoder3count*100/150/11/4;
	motor4speed=(float) encoder4count*100/150/11/4;
		printf("1:%.2f\r\n",motor1speed);
		printf("2:%.2f\r\n",motor2speed);
		printf("3:%.2f\r\n",motor3speed);
		printf("4:%.2f\r\n",motor4speed);
